        ...
        with open(input_file_path, 'r') as input_file, open(output_file_path, 'w') as output_file:
            ...
            for line in input_file:
                ...
                if      args[0] == "NOT":
                    ...
                    machine_code_line += "0001"
                    machine_code_line += parse_data_value(args[2], line_no)
                    
                elif    args[0] == "OR":
                                
                    machine_code_line += r0_or_r1(args[1], line_no)
                    machine_code_line += "0010"
                    machine_code_line += parse_data_value(args[2], line_no)
                  
                elif    args[0] == "AND":
                                
                    machine_code_line += r0_or_r1(args[1], line_no)
                    machine_code_line += "0011"
                    machine_code_line += parse_data_value(args[2], line_no)
                  
                elif    args[0] == "SUB":
                                
                    machine_code_line += r0_or_r1(args[1], line_no)
                    machine_code_line += "0100"
                    machine_code_line += parse_data_value(args[2], line_no)
                  
                elif    args[0] == "ADD":
                                
                    machine_code_line += r0_or_r1(args[1], line_no)
                    machine_code_line += "0101"
                    machine_code_line += parse_data_value(args[2], line_no)
                  
                elif    args[0] == "RR":
                
                    machine_code_line += "00"
                    machine_code_line += "0110"
                    machine_code_line += parse_data_value(args[1], line_no)
                
                elif    args[0] == "RL":
                
                    machine_code_line += "00"
                    machine_code_line += "0111"
                    machine_code_line += parse_data_value(args[1], line_no)
                
                elif    args[0] == "DEC":
                    
                    machine_code_line += "00"
                    machine_code_line += "1000"
                    machine_code_line += parse_data_value(args[1], line_no)
               
                elif    args[0] == "INC":
                    
                    machine_code_line += "00"
                    machine_code_line += "1001"
                    machine_code_line += parse_data_value(args[1], line_no)
                
                elif    args[0] == "LD":

                    machine_code_line += "00"
                    machine_code_line += "1010"
                    machine_code_line += parse_data_value(args[1], line_no)

                elif    args[0] == "ST":

                    machine_code_line += r0_or_r1(args[1], line_no)
                    machine_code_line += "101100000000"

                elif    args[0] == "NOP":
                
                    machine_code_line += "00110000000000"
                
                elif    args[0] == "RST":
                
                    machine_code_line += "00111100000000"
